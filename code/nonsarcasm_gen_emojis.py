...
import codecs
import csv
filee = codecs.open(r"C:/Users/Jaideep Jagani/Desktop/University/semester 6 books and lectures/Information Retrieval (IR)/Sarcasm-Detection-Twitter-master/data/nonsarcasm_tweets.txt", encoding='utf-8')
count=[]
temp=[]
laughter_expression=[]
for l in filee:
...
with open(r"C:/Users/Jaideep Jagani/Desktop/University/semester 6 books and lectures/Information Retrieval (IR)/Sarcasm-Detection-Twitter-master/data/nonsarcasm_emoji.csv",'w') as csvfile:
